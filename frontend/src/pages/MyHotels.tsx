    ...
    return (
        <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 gap-8">
                {hotelData.map((hotel) => (
                    <div className="flex flex-col justify-center border border-slate-300 rounded-lg p-8 gap-5">
                        ...
                        <div className="grid grid-cols-5 gap-2">
                            ...
                            <div className="border border-slate-300 rounded-sm p-3 flex items-center">
                                ...
                                KES {hotel.pricePerNight} per night
                            </div>
                            <div className="border border-slate-300 rounded-sm p-3 flex items-center">
                                <BiHotel className="mr-1"/>
                                {hotel.adultCount} abults, {hotel.childCount} children
                            </div>
                            <div className="border border-slate-300 rounded-sm p-3 flex items-center">
